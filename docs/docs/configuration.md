...
### Cloud Status
Display public status and incident signals for major cloud providers.

By default it shows AWS, Google Cloud, Azure, and Cloudflare.
...
##### `providers`
List of providers to display. Supported values are:
...
Aliases are also accepted (`google`, `google-cloud`, `microsoft-azure`, `cf`, etc.).
